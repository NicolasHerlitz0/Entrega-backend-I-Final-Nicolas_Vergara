  ...
  try {
    ...
    if (cid.length !== 24 || pid.length !== 24) {
      return err(
        ...
        400,
        INVALID_ID,
        "Los IDs deben ser ObjectId válidos (24 caracteres)"
      );
    }
  ...
  try {
    ...
    if (cart === null) {
      return err(
        ...
        404,
        CART_NOT_FOUND,
        "Carrito no encontrado o producto no está en el carrito"
      );
    }
  ...
  try {
    ...
    if (cid.length !== 24) {
      return err(
        ...
        400,
        INVALID_ID,
        "El ID del carrito debe ser un ObjectId válido (24 caracteres)"
      );
    }
    ...
    if (!Array.isArray(productsArray)) {
      return err(
        ...
        400,
        MISSING_FIELD,
        'El body debe contener un array "products"'
      );
    }
    ...
    if (cart === null) {
      return err(
        ...
        404,
        CART_NOT_FOUND,
        "Carrito no encontrado o algún producto no existe"
      );
    }
